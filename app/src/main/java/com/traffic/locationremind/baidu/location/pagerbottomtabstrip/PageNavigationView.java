package com.traffic.locationremind.baidu.location.pagerbottomtabstrip;
...
import com.traffic.locationremind.baidu.location.internal.CustomItemLayout;
import com.traffic.locationremind.baidu.location.internal.CustomItemVerticalLayout;
import com.traffic.locationremind.baidu.location.internal.MaterialItemLayout;
import com.traffic.locationremind.baidu.location.internal.MaterialItemVerticalLayout;
import com.traffic.locationremind.baidu.location.internal.Utils;
import com.traffic.locationremind.baidu.location.item.BaseTabItem;
import com.traffic.locationremind.baidu.location.item.MaterialItemView;
import com.traffic.locationremind.baidu.location.item.OnlyIconMaterialItemView;
import com.traffic.locationremind.baidu.location.listener.OnTabItemSelectedListener;
